...
class Conveyor(Frame):
    def __init__(self, master, picture, width):
        ...
        # final label
        self.final_label = Label(self, text = "FINAL", fg = 'red')
        self.final_label.grid(row = 0, column = 12)
        ...
        self.pointer = self.conveyor_canvas.create_polygon((10,2), (40,2), (25,30), \
    ...
    def random_shuffle(self):
        ...
        for idx in self.image_number_list:
            self.image_flags[idx] = True
